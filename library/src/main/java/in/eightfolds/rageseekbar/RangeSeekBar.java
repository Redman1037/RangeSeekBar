...
package in.eightfolds.rageseekbar;
...
import in.eightfolds.util.BitmapUtil;
import in.eightfolds.util.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultShadowYOffset = PixelUtil.INSTANCE.dpToPx(context, 2);
        int defaultShadowXOffset = PixelUtil.INSTANCE.dpToPx(context, 0);
        int defaultShadowBlur = PixelUtil.INSTANCE.dpToPx(context, 2);

        if (attrs == null) {
            setRangeToDefaultValues();
            internalPad = PixelUtil.INSTANCE.dpToPx(context, INITIAL_PADDING_IN_DP);
            barHeight = PixelUtil.INSTANCE.dpToPx(context, LINE_HEIGHT_IN_DP);
            ...
            try {
                ...
                if (normalDrawable != null) {
                    thumbImage = BitmapUtil.INSTANCE.drawableToBitmap(normalDrawable);
                }
                Drawable disabledDrawable = a.getDrawable(R.styleable.RangeSeekBar_thumbDisabled);
                if (disabledDrawable != null) {
                    thumbDisabledImage = BitmapUtil.INSTANCE.drawableToBitmap(disabledDrawable);
                }
                Drawable pressedDrawable = a.getDrawable(R.styleable.RangeSeekBar_thumbPressed);
                if (pressedDrawable != null) {
                    thumbPressedImage = BitmapUtil.INSTANCE.drawableToBitmap(pressedDrawable);
                }
        ...
        textSize = PixelUtil.INSTANCE.dpToPx(context, DEFAULT_TEXT_SIZE_IN_DP);
        distanceToTop = PixelUtil.INSTANCE.dpToPx(context, DEFAULT_TEXT_DISTANCE_TO_TOP_IN_DP);
        textOffset = !showTextAboveThumbs ? 0 : this.textSize + PixelUtil.INSTANCE.dpToPx(context,
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = thumbImage.getHeight()
                + (!showTextAboveThumbs ? 0 : PixelUtil.INSTANCE.dpToPx(getContext(), HEIGHT_IN_DP))
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (showTextAboveThumbs && (activateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            String minText = valueToString(getSelectedMinValue()) + " mins";
            String maxText = valueToString(getSelectedMaxValue()) + " mins";
            ...
            if (!singleThumb) {
                ...
                int spacing = PixelUtil.INSTANCE.dpToPx(getContext(), TEXT_LATERAL_PADDING_IN_DP);
